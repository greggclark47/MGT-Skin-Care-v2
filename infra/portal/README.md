...
The shared portal shell preserves the Skip to content link and moves keyboard focus to the main landmark after in-portal navigation. Opening the mobile menu focuses its first primary destination; Escape closes it and returns focus to Menu. This is a local keyboard-navigation improvement, not a substitute for a full assistive-technology or WCAG audit.
