...
The API blocks all prior checkout, cart, fulfillment, refund, payout, Connect-onboarding, consumer membership billing and Stripe webhook entry points. Old code and records remain preserved behind these gates; they are not an active commerce system. Direct links contain no affiliate tracking or customer-profile data.
